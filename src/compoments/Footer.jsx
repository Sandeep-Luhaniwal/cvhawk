...
const Footer = () => {
    return (
        <>
                        ...
                        <Col lg={6} md={7} className='pt-md-5'>
                            <div className='pt-md-3 d-flex justify-content-between pt-4 mt-1 mt-sm-0'>
                                <ul className='mb-0 ps-0 d-flex flex-column gap-20 '>
                                    ...
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>Home</Link></li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>About</Link></li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>We’ll help you</Link></li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>Testimonials</Link></li>
                                </ul>
                                <ul className='mb-0 ps-0 d-flex flex-column gap-20 '>
                                    <li className='ff_primary fs_sm fw_medium color_main'>Support</li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'><CallIcon /><span className='ps-1'>+012 345 67890</span></Link></li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'><MessageIcon /><span className='ps-1'>Cvhawk@gmail.com</span></Link></li>
                                </ul>
                                <ul className='mb-0 ps-0 d-flex flex-column gap-20 d-none d-sm-block '>
                                    ...
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>Privacy Policy</Link></li>
                                    <li><Link className='ff_primary fs_sm fw_regular op-9 color_main hoverfooter'>Terms & conditions</Link></li>
                                </ul>
                            </div>
            ...
            <div className='bg_footer bordertop'>
